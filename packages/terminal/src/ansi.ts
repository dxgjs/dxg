...
export const brightBlack = (text: string) =>
  fgColors.brightBlack + text + reset;
export const brightRed = (text: string) => fgColors.brightRed + text + reset;
export const brightGreen = (text: string) =>
  fgColors.brightGreen + text + reset;
export const brightYellow = (text: string) =>
  fgColors.brightYellow + text + reset;
export const brightBlue = (text: string) => fgColors.brightBlue + text + reset;
export const brightMagenta = (text: string) =>
  fgColors.brightMagenta + text + reset;
export const brightCyan = (text: string) => fgColors.brightCyan + text + reset;
export const brightWhite = (text: string) =>
  fgColors.brightWhite + text + reset;
...
export const bgBrightBlack = (text: string) =>
  bgColors.brightBlack + text + reset;
export const bgBrightRed = (text: string) => bgColors.brightRed + text + reset;
export const bgBrightGreen = (text: string) =>
  bgColors.brightGreen + text + reset;
export const bgBrightYellow = (text: string) =>
  bgColors.brightYellow + text + reset;
export const bgBrightBlue = (text: string) =>
  bgColors.brightBlue + text + reset;
export const bgBrightMagenta = (text: string) =>
  bgColors.brightMagenta + text + reset;
export const bgBrightCyan = (text: string) =>
  bgColors.brightCyan + text + reset;
export const bgBrightWhite = (text: string) =>
  bgColors.brightWhite + text + reset;
...
export const strikethrough = (text: string) =>
  styles.strikethrough + text + reset;
...
export function colorize(
  text: string,
  color: keyof typeof fgColors | keyof typeof bgColors,
  isBg: boolean = false,
): string {
